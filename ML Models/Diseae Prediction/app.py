...
from Fertilizer_recomendation.fertilizer_main import predict_npk,predict_fertilizer
from Fertilizer_recomendation.season import get_seasonal_weather
from Models import MarketTrend
from Mandi_Price_Tracking.mandi_price_tracking import get_price_data
...
with open("fertilizer_data.json", "r", encoding="utf-8") as fertilizer_file:
    fertilizer_data = json.load(fertilizer_file)
...
def recommend_fertilizer(data: FertilizerInput, lang: str = "eng"):
    """
